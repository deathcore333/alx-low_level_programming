...
/**
 * word_len - locates the index marking the end of the first word of the str
 * @str: a string
 *
 ...
 * @str: the string
 *
 * Return: pointer to array or NULL if string is Null or "" or it fails
 */
